...
class NewvisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # When she hits enter, the page updates, and not the page
        # lists "1: Buy peacokc feathers" as an item in a to-do list.
        ...
        # Edit wonders wheteher the site will remember her list.
